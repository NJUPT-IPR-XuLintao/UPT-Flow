...
import numpy as np
from models.modules.Lowlight_Encoder import MSFormer
...
class UPTFlow(nn.Module):
    ...
    def forward(self, gt=None, lr=None, z=None, zc=None,eps_std=None, reverse=False, epses=None, reverse_with_grad=False,
                lr_enc=None,add_gt_noise=True,  y_label=None,  get_color_map=False):
        if get_color_map:
        ...
        if not reverse:
            ...
            return self.normal_flow(gt, lr, zc,epses=epses, lr_enc=lr_enc, add_gt_noise=add_gt_noise,
                                    y_onehot=y_label)
        else:
